...
namespace BerilliumApp.Areas.admin.Controllers
{
    ...
    public class LocationsController : Controller
    {
        ...
        public LocationsController(HomeDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Img,Park,City,Id")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Img,Park,City,Id")] Location location)
        {
            if (id != location.Id)
            {
                return NotFound();
